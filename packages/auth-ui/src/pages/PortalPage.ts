...
const APPS: AppItem[] = [
  { abbr: 'SA', name: 'SI-ASN', desc: 'Sistem Informasi ASN', color: '#005598', category: 'kepegawaian', frequent: true },
  { abbr: 'eK', name: 'e-Kinerja', desc: 'Penilaian kinerja pegawai', color: '#01347C', category: 'kepegawaian', frequent: true },
  { abbr: 'SB', name: 'SIASN BKN', desc: 'Layanan kepegawaian BKN', color: '#2894D9', category: 'kepegawaian', frequent: true },
  { abbr: 'LP', name: 'LAPOR!', desc: 'Pengaduan layanan publik', color: '#C1272D', category: 'layanan' },
  { abbr: 'SP', name: 'SP4N', desc: 'Sistem pengelolaan pengaduan', color: '#15803D', category: 'layanan' },
  { abbr: 'JD', name: 'JDIH', desc: 'Dokumentasi & informasi hukum', color: '#7C3AED', category: 'layanan' },
  { abbr: 'eO', name: 'e-Office', desc: 'Perkantoran elektronik', color: '#0F766E', category: 'kepegawaian' },
  { abbr: 'SK', name: 'SKP Online', desc: 'Sasaran kinerja pegawai', color: '#B45309', category: 'kepegawaian' },
  { abbr: 'PR', name: 'Presensi', desc: 'Kehadiran & absensi', color: '#005598', category: 'kepegawaian' },
  { abbr: 'DK', name: 'Diklat', desc: 'Pendidikan & pelatihan', color: '#01347C', category: 'kepegawaian' },
  { abbr: 'AR', name: 'Arsip', desc: 'Manajemen arsip digital', color: '#5E7896', category: 'layanan' },
];
